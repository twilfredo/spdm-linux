...
static const struct nla_policy handshake_done_nl_policy[HANDSHAKE_A_DONE_RECORD_SIZE + 1] = {
	[HANDSHAKE_A_DONE_STATUS] = { .type = NLA_U32, },
	[HANDSHAKE_A_DONE_SOCKFD] = { .type = NLA_S32, },
	[HANDSHAKE_A_DONE_REMOTE_AUTH] = { .type = NLA_U32, },
	[HANDSHAKE_A_DONE_RECORD_SIZE] = { .type = NLA_U32, },
};
...
static const struct genl_split_ops handshake_nl_ops[] = {
	...
	},
	{
		...
		.maxattr	= HANDSHAKE_A_DONE_RECORD_SIZE,
